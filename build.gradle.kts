...
loom {
    ...
    launchConfigs {
        getByName("client") {
            ...
            arg("--mixin", "mixins.template.json")
        }
    }
    runConfigs {
        getByName("client") {
    ...
    mixin {
        defaultRefmapName.set("mixins.template.refmap.json")
    }
}
...
dependencies {
    ...
    shadeMod("com.github.LlamaLad7:MixinExtras:0.0.11")
...
tasks {
    jar {
        manifest.attributes(mapOf(
            ...
            "TweakOrder" to "0",
            "MixinConfigs" to "mixins.template.json"
        ))
    }
